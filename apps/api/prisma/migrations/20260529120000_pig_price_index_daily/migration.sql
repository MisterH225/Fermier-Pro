...
-- CreateTable
CREATE TABLE "PigPriceIndexDaily" (
    "id" TEXT NOT NULL,
    "date" DATE NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "PigPriceIndexDaily_date_category_key" ON "PigPriceIndexDaily"("date", "category");

-- CreateIndex
CREATE INDEX "PigPriceIndexDaily_date_idx" ON "PigPriceIndexDaily"("date" DESC);
