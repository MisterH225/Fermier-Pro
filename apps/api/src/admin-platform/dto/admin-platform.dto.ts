...
export class UpdatePlatformSettingsDto {
  ...
  /** Taux de commission marketplace prélevé sur l'acheteur (ex. 0.015 = 1,5 %). */
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(0.99)
  ...
  /** Taux de commission marketplace prélevé sur le vendeur (ex. 0.015 = 1,5 %). */
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(0.99)
  ...
  /** Taux de commission prélevé sur le montant versé au vétérinaire (ex. 0.015 = 1,5 %). */
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(0.99)
