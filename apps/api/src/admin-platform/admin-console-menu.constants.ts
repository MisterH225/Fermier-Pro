...
export const SUPERADMIN_ONLY_PATH_PREFIXES = [
  ...
  "/admin/feed-requirement-profiles",
  "/admin/metrics"
] as const;
...
export const ADMIN_ROUTE_MENU_RULES: RouteMenuRule[] = [
  ...
  { prefix: "/admin/merchant-subscription-promo-codes", menu: "merchantSubscriptions" },
  { prefix: "/admin/producer-subscriptions", menu: "producerSubscriptions" },
  ...
  { prefix: "/admin/feed-requirement-profiles", menu: "settings" },
