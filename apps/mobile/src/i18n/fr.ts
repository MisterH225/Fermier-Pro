export const fr = {
  ...
  profitability: {
    kpiCostPerKgSold: "Coût / kg vendu",
    kpiAvgSalePrice: "Prix vente moyen / kg",
    kpiMargin: "Marge / kg",
    kpiHerdValue: "Valeur cheptel estimée",
    realData: "Données réelles ✅",
    estimated: "Estimation ⚠️",
    profitable: "🟢 Rentable",
    notProfitable: "🔴 Non rentable",
    icTitle: "Indices de consommation par phase",
    icDesc: "Efficacité alimentaire — comparer à vos objectifs",
    icTarget: "IC cible",
    icAbove: "{{pct}} % au-dessus de l'objectif",
    icBelow: "{{pct}} % en dessous de l'objectif",
    icUnavailable: "Données insuffisantes",
    icGlobal: "IC global indicatif : {{ic}}",
    icExplain: "Un IC de {{ic}} signifie qu'il faut {{ic}} kg d'aliment pour 1 kg de porc vif. Objectif : {{target}}.",
    feedConsumed: "Aliment consommé",
    kgGained: "Kg gagnés",
    feedPhaseWarning: "Qualifiez vos types d'aliment dans Stock pour activer le calcul par phase.",
    costBreakdownTitle: "Décomposition du coût de revient",
    colPost: "Poste",
    colAmount: "Montant",
    colPct: "% total",
    colPerKg: "Coût/kg",
    ...
    chartCost: "Coût / kg",
    chartPrice: "Prix vente / kg",
    chartBreakEven: "Seuil rentabilité",
    simTitle: "Simulation",
    simDesc: "Et si je modifiais un paramètre ?",
    simSalePrice: "Prix vente",
    simIc: "IC alimentation",
    simHeadcount: "Effectif",
    simInputPh: "Valeur",
    simRun: "Calculer",
    simFeedSavings: "Économie aliment estimée",
    settingsTitle: "Rentabilité",
    marketPricePerKg: "Prix marché / kg (porc vif)",
    marketPriceHelp: "Utilisé pour valoriser le cheptel actuel",
    icTargetStarter: "IC cible — Démarrage",
    icTargetGrowth: "IC cible — Croissance",
    icTargetFattening: "IC cible — Engraissement",
    gmqRefStarter: "GMQ réf. démarrage (g/j)",
    gmqRefGrowth: "GMQ réf. croissance (g/j)",
    gmqRefFattening: "GMQ réf. engraissement (g/j)",
    saveSettings: "Enregistrer rentabilité",
    savedSettings: "Paramètres rentabilité enregistrés",
    feedPhaseLabel: "Phase de production",
    feedPhaseHelp: "Nécessaire pour le calcul IC par phase",
    phaseStarter: "Démarrage",
    phaseGrowth: "Croissance",
    phaseFattening: "Engraissement",
    phaseBreeder: "Reproducteurs",
    phaseUnknown: "Non renseigné"
  },
  ai: {
