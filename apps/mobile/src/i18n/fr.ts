export const fr = {
  ...
  addPhone: {
    ...
    alreadyHasPhone: "Ce numéro est déjà associé à ce compte.",
  ...
  buyer: {
    ...
    dashboard: {
      ...
      proposalsTitle: "Propositions en cours",
      proposalsEmpty: "Aucune proposition pour le moment. Explorez le marché pour en envoyer.",
      proposalCount: "{{count}} offre(s)",
      proposalStatus: {
        pending: "En attente",
      ...
      viewProposals: "Voir mes propositions",
      purchasesTitle: "Mes achats",
      purchasesSubtitle: "Total des achats aboutis",
      purchasesEmpty: "Aucun achat abouti sur cette période.",
      purchasesMeta: "{{count}} achat(s) · période préc. {{previous}}",
      purchasesDelta: "{{value}} % vs période précédente",
      purchasesDeltaFlat: "Stable vs période précédente",
      purchasesNoBaseline: "Pas de comparaison (période précédente à zéro)",
      periodMonth: "Mois",
      periodQuarter: "Trimestre",
      periodYear: "Année",
      viewPurchases: "Voir l'historique",
      creditTitle: "Crédits en cours",
