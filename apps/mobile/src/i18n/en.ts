export const en = {
  ...
  profitability: {
    kpiCostPerKgSold: "Cost / kg sold",
    kpiAvgSalePrice: "Avg. sale price / kg",
    kpiMargin: "Margin / kg",
    kpiHerdValue: "Estimated herd value",
    realData: "Real data ✅",
    estimated: "Estimate ⚠️",
    profitable: "🟢 Profitable",
    notProfitable: "🔴 Not profitable",
    icTitle: "Feed conversion by phase",
    icDesc: "Feed efficiency vs. your targets",
    icTarget: "Target FCR",
    icAbove: "{{pct}}% above target",
    icBelow: "{{pct}}% below target",
    icUnavailable: "Insufficient data",
    icGlobal: "Global FCR (indicative): {{ic}}",
    icExplain:
      "FCR {{ic}} means {{ic}} kg of feed per 1 kg live weight. Target: {{target}}.",
    feedConsumed: "Feed consumed",
    kgGained: "Kg gained",
    feedPhaseWarning:
      "Classify feed types in Stock to enable per-phase FCR.",
    costBreakdownTitle: "Cost breakdown",
    colPost: "Item",
    colAmount: "Amount",
    colPct: "% of total",
    colPerKg: "Cost/kg",
    evolutionTitle: "6-month trend",
    chartCost: "Cost / kg",
    chartPrice: "Sale price / kg",
    chartBreakEven: "Break-even",
    simTitle: "Simulation",
    simDesc: "What if you changed a parameter?",
    simSalePrice: "Sale price",
    simIc: "Feed FCR",
    simHeadcount: "Headcount",
    simInputPh: "Value",
    simRun: "Calculate",
    simFeedSavings: "Estimated feed savings",
    settingsTitle: "Profitability",
    marketPricePerKg: "Market price / kg (live weight)",
    marketPriceHelp: "Used to value the current herd",
    icTargetStarter: "Target FCR — Starter",
    icTargetGrowth: "Target FCR — Growth",
    icTargetFattening: "Target FCR — Finishing",
    gmqRefStarter: "Ref. ADG starter (g/day)",
    gmqRefGrowth: "Ref. ADG growth (g/day)",
    gmqRefFattening: "Ref. ADG finishing (g/day)",
    saveSettings: "Save profitability settings",
    savedSettings: "Profitability settings saved",
    feedPhaseLabel: "Production phase",
    feedPhaseHelp: "Required for per-phase FCR",
    phaseStarter: "Starter",
    phaseGrowth: "Growth",
    phaseFattening: "Finishing",
    phaseBreeder: "Breeders",
    phaseUnknown: "Not set"
  },
  ai: {
