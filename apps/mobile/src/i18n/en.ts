export const en = {
  ...
  addPhone: {
    ...
    changeTitle: "Change my number",
    sectionTitle: "Phone number",
    addButton: "Add my number",
    changeButton: "Change my number",
    maskedHint: "Visible only to you, shown masked.",
    currentNumber: "Current number: {{phone}}",
    receiveCode: "Receive code",
    verify: "Verify",
    resend: "Resend code",
    resendCooldown: "Resend code ({{seconds}}s)",
    hintPhone: "Add your mobile number to secure your account and receive SMS codes.",
    hintChange: "Enter a new number. An SMS code will confirm the change.",
    hintOtp: "Enter the 6-digit code received by SMS.",
    success: "Phone number verified and saved.",
    successChange: "Phone number updated.",
    ...
    alreadyHasPhone: "This number is already linked to this account.",
  ...
  account: {
    ...
    sensitiveZone: {
      ...
      resolveHints: {
        ...
        wallet: { withdrawals: "Open my balance" },
        merchant: {
      ...
      blocks: {
        ...
        BUYER_OPEN_TRANSACTION: "{{count}} open marketplace purchase(s) — close them first.",
    ...
    deleteAccount: {
      ...
      consequences: {
        ...
        finance: "✗ All your financial movements",
  ...
  marketScreen: {
    ...
    partners: {
      transactionCount: "{{count}} purchase(s)",
    ...
    meteoBuyer: {
      ...
      current: "Current",
      stats: "{{total}} purchases, {{onTime}} on time"
    },
    ...
    transaction: {
      ...
      shortStatus: {
        ...
        DELIVERY_DISPUTED: "Delivery problem",
      ...
      transactionNotFound: "Purchase not found. Refresh the screen or reopen it from your proposals.",
      ...
      sellerWeightDeclaredBody: "The gap with the buyer is shown. Accept or request a decision if thresholds are met.",
      weightDiffSection: "Weight difference",
      weightDiffLine: "Difference: {{kg}} kg",
      arbitrationThresholdsHint: "Decision thresholds: {{min}} kg per animal · {{cumulative}} kg cumulative",
      requestArbitration: "Request a decision",
      belowArbitrationThreshold: "Gap below decision threshold — negotiate or accept with the other party.",
      arbitrationRequestedTitle: "Decision requested",
      arbitrationRequestedBody: "A platform admin will review this purchase.",
      validateWeight: "Confirm weight",
      ...
      buyerWaitHandover: "Weight confirmed. The seller will confirm handover.",
      buyerWaitReceipt: "The seller confirmed handover. Confirm receipt to finalize and release payment.",
      deliveryDisputed: "A delivery problem is open. Funds remain secured pending resolution.",
      finalizing: "Receipt confirmed — paying the seller and closing the purchase.",
      weightDisputed: "Weight is contested. A decision is in progress — you will be notified."
    },
    shipmentModal: {
    ...
    credit: {
      ...
      escrow: {
        transactionMissing: "Held-payment entry not found — try again shortly."
      },
      termsAdvance: "Advance: {{pct}}% = {{amount}}",
      termsBalance: "Balance: {{amount}} in {{days}} days",
      advance: {
        confirm: "✅ I paid the advance",
        payEscrow: "💳 Pay advance (held)",
        viewTransaction: "View purchase",
      ...
      balance: {
        ...
        payEscrow: "💳 Pay balance (held)",
        remaining: "Remaining balance",
        statusPending: "Awaiting payment",
        statusDeclared: "Payment declared",
        statusPaid: "Settled",
        statusArbitration: "Decision in progress",
    ...
    receiptModal: {
      ...
      successBody: "The purchase is moving toward closing."
    },
    categories: {
      all: "All",
      piglet: "Piglets",
    ...
    detail: {
      ...
      health: {
        globalStatus: "Vaccination state",
  ...
  pigPriceIndex: {
    ...
    statHigh: "High",
    statLow: "Low",
    statVolume: "Purchases",
    variationFlat: "0.0% ➡️",
    priceOnRequest: "—"
  },
  pigPriceIndexCard: {
    title: "Pork price index",
    basedOn: "Based on {{count}} purchases"
  },
  ordersTracking: {
  ...
  vet: {
    ...
    appointment: {
      ...
      paymentRecapTitle: "Payment summary",
      payCta: "Pay {{amount}} via Mobile Money",
      paymentSuccessTitle: "Payment confirmed",
      paymentSuccessBody: "Your appointment is confirmed. The vet has been notified.",
      refuseAmountCta: "Decline this amount",
      refuseAmountTitle: "Decline this amount?",
      refuseAmountBody: "The proposal will be cancelled. No payment will be charged.",
      freeBadge: "Free",
      proposalTitle: "Visit proposal",
      ...
      producerAcceptedFreeBody: "Free visit confirmed. No payment will be requested.",
      completeHint: "Confirm only if the service was delivered. This triggers payment to the vet.",
      completeFreeHint: "Mark the visit as completed. No settlement will occur.",
      completeCta: "Confirm service completed",
      completeFreeCta: "Mark as completed",
      ...
      cancelHintPaid: "The held amount will be fully refunded to the producer’s balance. The other party will see your note.",
    ...
    account: {
      ...
      openShort: "Open",
      walletRow: "Earnings & withdrawals",
      school: "Training",
      verifiedAt: "Verified on",
      diplomaReadonly: "Read-only — changed only after verification.",
      nextField: {
        bio: "Add a bio to rank higher in producer search →",
        otherSpecialties: "Add more specialties to broaden your showcase →",
        interventionRadiusKm: "Set your service radius →",
        profilePhotoUrl: "Add a professional profile photo →",
        availability: "Turn on availability to receive requests →"
      }
    },
    agenda: {
    ...
    schedule: {
      title: "Propose a visit",
      confirm: "Propose visit",
      farm: "Farm",
      reason: "Reason",
      notes: "Notes",
      notesPlaceholder: "Observations, instructions…",
      pricingChoice: "Pricing",
      pricingPaid: "Paid",
      pricingFree: "Free",
      pricingRequired: "Choose Paid or Free before sending.",
      price: "Service amount (FCFA)",
      pricePlaceholder: "e.g. 25000",
      priceRequired: "Enter an amount greater than 0.",
      freeHint: "No payment will be requested from the producer.",
      pickSlot: "Select a time slot above.",
      noFarms: "No assigned farms.",
      missingFields: "Choose a farm, time slot and pricing.",
      ...
      successBodyProposed: "Proposal sent to {{farm}} for {{date}}. The producer must accept or decline.",
      reasons: {
        routine: "Routine",
        urgency: "Urgent",
        followup: "Follow-up",
  ...
  navigation: {
    ...
    screenTitles: {
      ...
      merchantDispute: "Problem",
      merchantSubscription: "Subscription",
      producerSubscription: "Team Premium",
      userWallet: "My balance",
      walletTopUp: "Top up",
      ...
      createVetConsultation: "Log an off-platform visit",
  ...
  feedStock: {
    ...
    edit: {
      ...
      linkedWarning: "This entry is linked to a Finance expense. Editing the cost here also updates the Finance movement.",
      costSection: "Cost",
  ...
  cheptel: {
    ...
    noLogs: "No state changes recorded.",
    loadMore: "Load more",
  ...
  financeScreen: {
    ...
    recentTx: "Recent movements",
    viewAll: "View all",
    viewLess: "Show less",
    noTx: "No movements yet.",
    ...
    newTx: "+ Movement",
    modalTitle: "New movement",
    expense: "Expense",
    income: "Income",
    autoGenerated: "Automatic",
    autoGeneratedLocked: "This automatic expense cannot be edited.",
    ...
    save: "Save",
    editSuccessMessage: "Movement updated.",
    ...
    fieldDate: "Date",
    transactionRef: "Movement reference",
    transactionRefHint: "Generated automatically for this entry.",
    noteRef: "Movement ref: {{ref}}",
    ...
    txSuccessMessage: "Movement saved.",
    marginRev: "Revenue:",
  ...
  financeStockLink: {
    ...
    deleteLinkedBody: "This movement is linked to a stock entry. Delete the stock entry too?",
  ...
  historicalRecords: {
    ...
    walletHint: "These amounts feed project profitability and P&L. They do not affect your balance.",
    addData: "Add data",
  ...
  vetOnboarding: {
    ...
    vitrineStepLabel: "Your showcase (pending review)",
    vitrineTitle: "Your showcase",
    vitrineLead: "Your showcase will be visible to producers once your account is reviewed.",
  ...
  health: {
    ...
    mortalityHint: "After saving, animal state / exit is updated — pull to refresh.",
    ...
    kpiGlobalStatus: "Overall health state",
    globalStatus: {
      good: "Good",
      warning: "Attention",
      critical: "Critical"
    ...
    vetSearch: {
      ...
      available: "Available",
      unavailable: "Unavailable",
      otherSpecialties: "Other specialties: {{list}}",
      radiusKm: "Service radius: {{km}} km",
      radiusKmShort: "{{km}} km",
      reviews: "reviews",
      completedAppointments: "{{count}} completed visits",
  ...
  invite: {
    ...
    previewScanRequest: "Request sent: the owner will review your access and assign your role.",
  ...
  buyer: {
    ...
    account: {
      ...
      meteoStats: "{{total}} purchases · {{onTime}} on-time payments · Visible to producers on your offers.",
      meteoLevel: {
        debutant: "Grey cloud",
        eclaircie: "Clearing",
        brise: "Light breeze",
    ...
    dashboard: {
      ...
      proposalsTitle: "Open proposals",
      proposalsEmpty: "No proposals yet. Browse the market to send one.",
      proposalCount: "{{count}} offer(s)",
      proposalStatus: {
        pending: "Pending",
        countered: "Countered",
        accepted: "Accepted",
      ...
      purchasesSubtitle: "Completed purchase total",
      purchasesEmpty: "No completed purchases in this period.",
      purchasesMeta: "{{count}} purchase(s) · prev. period {{previous}}",
      purchasesDelta: "{{value}} % vs previous period",
      purchasesDeltaFlat: "Flat vs previous period",
      purchasesNoBaseline: "No comparison (previous period was zero)",
      periodMonth: "Month",
      periodQuarter: "Quarter",
      periodYear: "Year",
      viewPurchases: "View history",
      creditTitle: "Open credit",
    ...
    wallet: {
      ...
      entry: {
        ...
        escrowRelease: "Held payment payout",
      ...
      ops: {
        ...
        topUpPendingBody: "Complete the payment in your browser. Your balance will update automatically once payment is confirmed.",
        ...
        transfer: "Transfer",
        transferHint: "Transfers between Fermier Pro balances. Any fees are shown before you confirm.",
        transferCta: "Send",
  ...
  buyerOnboarding: {
    ...
    stepPrefsTitle: "Who are you?",
    stepPrefsBody: "Type, categories and volume — to personalize the Market.",
    stepSeekTitle: "What you're looking for",
    stepSeekBody:
    "Price, radius and location for relevant listings near you.",
    recapTitle: "Your buyer profile",
    recapBody:
    "You can refine later in Account. Goal: a solid gauge from day one.",
    fullName: "Name / business",
    location: "Location",
    locationPh: "City or neighborhood",
    locationFromMap: "Map point ({{lat}}, {{lng}})",
    pickOnMap: "Pick on the map",
    phone: "Phone",
    volume: "Typical volume",
    priceRange: "Price range",
    priceRangeHint: "Indicative market price in CFA francs / kg",
    priceValue: "{{price}} F/kg",
    skipPrice: "Skip price range",
    priceSkipped: "Range skipped — suggestion under Account gauge.",
    searchRadius: "Search radius",
    radiusKm: "{{km}} km",
    skipRadius: "Skip radius",
  ...
  deadline: {
    ...
    outcome: {
      ...
      weightAutoValidate: "Without a reply from the seller before the deadline, the weight will be confirmed automatically.",
  ...
  merchant: {
    ...
    products: {
      ...
      status: {
        resubmission_review: "Awaiting review"
      },
      sales: {
    ...
    orders: {
      ...
      openDispute: "Report a problem",
      disputeManage: "Manage problem",
    ...
    dispute: {
      title: "Order problem",
      subtitle: "Describe the issue (delivery, quality, etc.). No weight decision here.",
      reasonLabel: "Reason",
      reasonPh: "Explain the problem…",
      submit: "Report a problem",
      opened: "Problem reported",
    ...
    subscription: {
      ...
      payMobileMoney: "Wave / Mobile money",
      payWallet: "Balance",
      ctaPremiumWallet: "Pay with balance — {{price}} XOF{{period}}",
    ...
    product: {
      ...
      moderation: {
        ...
        hint: "Fix the product, then submit it again for review.",
        pendingHint: "Your product is awaiting another review. It is not visible on the marketplace.",
        resubmit: "Fix and submit for review",
